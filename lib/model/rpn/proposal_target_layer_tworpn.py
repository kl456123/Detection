...
class _ProposalTargetLayer(nn.Module):
    ...
    def forward(self, all_rois, gt_boxes, rois_order, bbox_coder):
        ...
        labels, rois, bbox_targets, bbox_inside_weights, rois_order = self._sample_rois_pytorch(
            all_rois, gt_boxes, fg_rois_per_image, rois_per_image,
            self._num_classes, rois_order)

        bbox_outside_weights = (bbox_inside_weights > 0).float()

        return rois, labels, bbox_targets, bbox_inside_weights, bbox_outside_weights, rois_order
    ...
    def _compute_targets_pytorch(self, ex_rois, gt_rois):
        ...
        targets = self.bbox_coder.encode_batch(ex_rois, gt_rois)
    ...
    def _sample_rois_pytorch(self, all_rois, gt_boxes, fg_rois_per_image,
                             rois_per_image, num_classes, rois_order):
        ...
        rois_order_batch = rois_order.new(batch_size, rois_per_image).fill_(-1)
        ...
        for i in range(batch_size):
            ...
            rois_order_batch[i] = rois_order[i][keep_inds]
        ...
        return labels_batch, rois_batch, bbox_targets, bbox_inside_weights, rois_order_batch

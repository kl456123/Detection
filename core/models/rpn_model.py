...
from lib.model.rpn.anchor_target_layer import _AnchorTargetLayer as AnchorTarget
from lib.model.rpn.anchor_target_layer_new import _AnchorTargetLayer as AnchorTargetNew
...
class RPNModel(Model):
    def forward_old(self, feed_dict):
        ...
        if self.training:
            ...
            rpn_data = self.rpn_anchor_target(
                (rpn_cls_prob.data, gt_boxes, im_info))
    ...
    def loss(self, prediction_dict, feed_dict):
        ...
        pos_indicator = rpn_cls_targets == 1

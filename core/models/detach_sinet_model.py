...
class DetachSINetModel(Model):
    ...
    def caroi_pooling(self, all_feats, rois_batch, out_channels):
        ...
        pooled_feats = pooled_feats.detach()
    ...
    def forward(self, feed_dict):
        ...
        pooled_feat_reg = self.rcnn_pooling(base_feat, rois_batch.view(-1, 5))

        pooled_feat_cls = self.caroi_pooling(
            all_feats, rois_batch.view(-1, 5), out_channels=1024)

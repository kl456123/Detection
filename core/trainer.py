        ...
        for epoch in range(self.start_epoch, self.max_epochs + 1):
            ...
            for step, data in enumerate(data_loader):
                ...
                if step and step % self.disp_interval == 0:
                    ...
                    summary_writer.add_scalar_dict(loss_dict,
                                                   total_step + step)

                    # # # summary metric
                    # # summary_writer.add_scalar('metric/rpn_ap', rpn_ap)
                    # summary_writer.add_scalar('metric/rpn_ar', matched /
                    ...
                    # recall
                    print((
                        "\t\t\tmatched_gt/all_gt/average recall({}/{}/{:.4f}): "
                    ).format(matched, num_gt, matched / num_gt))
                    # prec
                    print((
                        "\t\t\tnum_tp/num_det/average precision({}/{}/{:.4f}): "

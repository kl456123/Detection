# -*- coding: utf-8 -*-
"""
Modify from rpn model(just like a one stage)
"""
...
class RPNModel(Model):
    ...
    def init_modules(self):
        ...
        # heatmap format instead of regression
        self.rpn_keypoint_preds = nn.Conv2d(512, self.num_joints, 1, 1, 0)
    ...
    def forward(self, bottom_blobs):
        ...
        keypoint_heatmap = self.rpn_keypoint_preds(rpn_conv)
        ...
        predict_dict = {
            ...
            'rpn_keypoint_preds': keypoint_heatmap
        }

...
class TargetAssigner(object):
    def __init__(self, assigner_config):
        ...
        self.similarity_calc = similarity_calcs.build({'type': 'center'})
        ...
        self.matcher = matchers.build({'type': 'argmax'})
    ...
    def assign(self,
        ...
        fake_match = self.matcher.match_batch(match_quality_matrix, num_instances, 0.7)
        stats = Analyzer.analyze_recall(fake_match, num_instances, gt_boxes.shape[1])
        # match
        # shape(N,K)
        ...
        return cls_targets, reg_targets, cls_weights, reg_weights, reg_targets_3d, reg_weights_3d, stats

...
if __name__ == '__main__':
    ...
    while (num_images >= 0):
        ...
        # Load the demo image
            ...
            im_file = './bev_images/005936_img.pkl'
            im_in = read_pkl(im_file)
        ...
        for j in xrange(1, len(pascal_classes)):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    import ipdb
                    ipdb.set_trace()
                    gt_boxes = read_pkl('bev_images/bbox/005936_box.pkl')
                    visualize(im2show, cls_dets.cpu().numpy()[:, :4], gt_boxes)
                    import ipdb
                    ipdb.set_trace()

...
class Corner3DCoder(object):
    ...
    def encode(label_boxes_3d, p2):
        ...
        center_depth = torch.norm(location[:, [0, 2]], dim=-1, keepdim=True)
        center_2d = geometry_utils.torch_points_3d_to_cylinder_points_2d(location, p2, radus=864)
        ry = label_boxes_3d[:, -1:]
